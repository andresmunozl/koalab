    ...
    <div class="container">
        ...
        <div class="card-block">
            ...
            <div class="form-gr oup row">
                <label class="col-md-3 col-form-label">Director de grupo</label>
                <div class="col-md-9">
                    <select class="custom-select form-control" v-model="oferta.director_id">
                        <option v-for="item in docents" v-bind:value="item.id">{{item.user.name}} {{item.user.lastname}}</option>
                    </select>
                </div>
            </div>
       ...
       <router-link to="/admin/ofertas" class="btn btn-lg btn-danger" v-bind:class="{disabled: saving}" style="color: white">
           Cancelar
       </router-link>
       <br>
       <br>
                    ...
                    <div >
                        ...
                        <div class="col-md-4">
                            ...
                            <div v-if="finish">
                                ...
                                <router-link to="/admin/ofertas" class="btn btn-lg btn-primary" style="color: white">
                                    Aceptar
                                </router-link>
                                <br>
                                <br>
        ...
        methods:{
            getGroups(){
                axios.get(this.urlG).then(response => {
                    ...
                    this.docents = response.data.docents;
                }).catch(error => {
