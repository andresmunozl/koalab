        ...
        <div class="row">
            <nav class="sidebar col-xs-12 col-sm-4 col-lg-3 col-xl-2">
                ...
                <ul class="nav nav-pills flex-column sidebar-nav">
                    <li class="nav-item"><a class="nav-link " href="#/admin"><em class="fa fa-dashboard"></em> Dashboard <span class="sr-only">(current)</span></a></li>
                    <li class="nav-item"><a class="nav-link" href="#/admin/materias"><em class="fa fa-calendar-o"></em>Materias</a></li>
                    <li class="nav-item"><a class="nav-link" href="#/admin/ofertas"><em class="fa fa-bar-chart"></em> Ofertas</a></li>
                    <li class="nav-item"><a class="nav-link" href="#/admin/groups"><em class="fa fa-bar-chart"></em>Grupos</a></li>
                    <li class="nav-item"><a class="nav-link" href="#/admin/sedes"><em class="fa fa-bar-chart"></em>Sedes</a></li>
...
{{--                                <h4 class="mb-1">{{ Auth::user()->name }} {{ Auth::user()->lastname }}</h4>--}}
                                <h4 class="mb-1">{{ Auth::user()->rol }}</h4>
