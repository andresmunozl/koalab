    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card text-white bg-primary">
                ...
                <div class="card-body">
                    <div id="user" xmlns:v-bind="http://www.w3.org/1999/xhtml" xmlns:v-bind="http://www.w3.org/1999/xhtml">
                            ...
                            <div class="form-group is-empty">
                                ...
                                <div >
                                    <input type="text"  name="user"
                                           id="user"  class="form-control" v-model="user" placeholder="Nombre de usuario">
                                </div>
                            </div>
                            <div class="form-group is-empty">
