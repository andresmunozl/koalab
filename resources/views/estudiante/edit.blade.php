<form method="POST" v-on:submit.prevent="updateUser(user.id)" xmlns:v-on="http://www.w3.org/1999/xhtml"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input  type="text" class="form-control " v-model="user.lastname" name="lastname"  required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input  type="number" class="form-control" name="document" v-model="user.document" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <select name="rol" class="custom-select form-control" v-model="user.rol" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input  type="numer" class="form-control" name="phone" v-model="user.phone" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input  type="password" class="form-control" name="password_confirmation" v-model="user.confirmed" required>
                        </div>
                    </div>
